...
class TestShoppingItemsCase(TestShoppingItemsBaseCase):
    ...
    def test_user_cannot_add_items_in_non_existing_shoppinglist(self):
        ...
        # create shopping item response.
        shoppingitem_response = self.create_shoppingitem(auth_token, shl_id, data)

        res_data = json.loads(shoppingitem_response.get_data(as_text=True))

        self.assert404(shoppingitem_response)
        self.assertTrue(res_data['message'], shoppinglist_not_found)
    ...
    def test_cannot_add_items_with_name_that_exist(self):
        ...
        res = self.create_shoppingitem(auth_token, shl_id, data)
    ...
    def test_cannot_view_specific_shoppingitem_detail_if_shoppinglist_id_does_not_exist(self):
        ...
        self.assertTrue(retrieved_data['message'] == shoppinglist_not_found)

    def test_cannot_view_specific_shoppingitem_detail_if_shoppingitem_id_does_not_exist(self):
        self.register_user()
        login_response = self.login_user()
        ...
        # assertions.
        self.assert404(retrieve_resp)
        self.assertTrue(retrieved_data['message'] == shoppingitem_not_found)
    ...
    def test_user_can_delete_all_shoppingitems(self):
        ...
        item_3 = dict(
            name=self.testdata_3.name,
            price=self.testdata_3.price,
        ...
        self.assert200(res)
        self.assertEqual(res_data['message'], shoppingitems_deleted)
    ...
    def test_user_cannot_delete_all_shoppingitems_using_incorrect_password(self):
        ...
        self.assert403(res)
        self.assertEqual(res_data['message'], shoppingitems_not_deleted)
    ...
    def test_user_cannot_delete_all_shoppingitems_in_a_non_existing_shoppinglist(self):
        ...
        self.assert404(res)
        self.assertEqual(res_data['message'], shoppinglist_not_found)
    ...
    def test_user_cannot_delete_all_shoppingitems_in_an_empty_shoppinglist(self):
        ...
        self.assert404(res)
        self.assertEqual(res_data['message'], shoppinglist_empty)
